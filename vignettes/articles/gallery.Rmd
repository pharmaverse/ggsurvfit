...
To place figures with risk tables side-by-side, utilize the `ggsurvfit_build()` function.
Importantly, you _must_ build the plots before they can be cobbled together with {patchwork}.
