...
# add some kind indicator that we allow all ggplot2 modifications
dplyr::tribble(
  ~Package,             ~CRAN,    ~`Kaplan-Meier`, ~`Risk Table for Kaplan-Meier`, ~`Competing Risks`, ~`Risk Table for Competing Risks`,
  "ggsurvfit",            "X",                "X",                            "X",                "X",                               "X",
  "survminer",            "X",                "X",                            "X",                "X",                                "",
  "KMunicate",            "X",                "X",                            "X",                 "",                                "",
  "`GGally::ggsurv()`",   "X",                "X",                             "",                 "",                                "",
