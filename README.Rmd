...
gt_related_pkgs <-
  dplyr::tribble(
    ...
    "ggsurvfit",            "X",        "X",                  "X",       "X",                 "X",      "X",  "ddsjoberg",            "ggsurvfit",     "main",
  ...
  gt::tab_footnote(
    footnote = "Allows any {ggplot2} function to modify plot area (including scales) and the risktables align with plot.",
